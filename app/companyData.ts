...
import akcelRealtyLogo from "@/images/realty.png";
...
With a clear mission to nurture young racing talent and compete at the highest levels, the team embodies the AKCEL Group's vision of innovation, ambition, and performance at the forefront of global racing.`,
  ...
  },
  {
    ...
    slug: "akcel-entertainment-media",
    description: `A dynamic and forward-thinking company specializing in media and communication services, including audio/video production, podcasts, event organization, and artist management.

Committed to innovation, the company is also expanding into the thriving world of e-gaming, creating opportunities for gamers and content creators alike.
...
By combining cutting-edge education, industry insights, and hands-on experience, AKCEL Academy aims to empower professionals and drive innovation, growth, and success in the UAE’s thriving business landscape.`,
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1503676382389-4809596d5290?auto=format&fit=crop&w=800&q=80", // training
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80", // students
      "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80", // teacher
      "https://images.unsplash.com/photo-1465101178521-c1a9136a3b99?auto=format&fit=crop&w=800&q=80", // seminar
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=800&q=80", // group learning
    ],
  },
  {
    title: "AKCEL Investments (Coming Soon)",
    slug: "akcel-investments",
    description: `AKCEL Investments is all set to redefine investment opportunities by introducing a diverse range of alternative investment products, including Real Estate Funds, Development Funds, and Sports Funds.

With a strategic vision to empower investors and drive high-value growth, the company offers innovative investment solutions designed to unlock new avenues in real estate, infrastructure development, and the dynamic world of sports.
