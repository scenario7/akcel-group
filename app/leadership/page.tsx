...
const Page = () => {
  ...
  <div className="bg-black w-full md:w-1/4 aspect-square flex flex-col justify-between overflow-hidden shadow-lg">
    ...
    />
    <div className="text-center px-4 py-3 h-1/3 flex flex-col justify-center">
      <h2 className={`${montserrat.className} text-2xl text-white font-semibold`}>Amit Kaushal</h2>
      <p className={`${openSans.className} text-white/70 font-semibold tracking-tight`}>
