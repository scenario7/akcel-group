    ...
    return (
        <div className="flex flex-col">
            <div className="flex justify-between bg-[#000000] px-10 items-center">
                    <Image src={redLogo.src} alt="Akcel Group Logo" height={50} width={200} priority />
                <NavigationMenu>
                    <NavigationMenuList className={`space-x-4 ${openSans.className} text-white font-semibold tracking-tight`}>
                        <NavigationMenuItem>
                            <NavigationMenuTrigger className={`${openSans.className} bg-transparent text-white font-semibold tracking-tight`}>About Us</NavigationMenuTrigger>
                            <NavigationMenuContent>
                        ...
                        <NavigationMenuItem>
                            <NavigationMenuTrigger className={`${openSans.className} bg-transparent text-white font-semibold tracking-tight`}>Our Brands</NavigationMenuTrigger>
                            <NavigationMenuContent>
                                <div className={`flex flex-col rounded min-w-[220px] ${openSans.className} text-white tracking-tight`}>
                                    {akcelCompanies.map((company, index) => (
                                        <NavigationMenuLink key={index} href={`companies/${company.slug}`}>{company.title}</NavigationMenuLink>
                                    ))}
                                </div>
                            </NavigationMenuContent>
                        </NavigationMenuItem>
