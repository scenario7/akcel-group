          ...
          <NavigationMenu>
            ...
            >
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className={`flex flex-col rounded min-w-[220px] ${openSans.className} text-white`}>
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className={`flex flex-col rounded min-w-[180px] ${openSans.className} text-white`}>
